...
export default {
    ...
    methods: {
    addproject(){
      this.$store.dispatch('add_project', {name:this.name, summary:this.summary})
    },
    deletetodo(id){
    ...
    edit(){
       ...
       this.$store.dispatch('edit_project', {id:this.editid,name:this.ename, summary:this.esummary})
    },
